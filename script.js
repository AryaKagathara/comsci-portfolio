...
const PORTFOLIO_DATA = {
    "Brand-Guidelines": {
        type: "pdf",
        files: [
            "MascotYou.pdf", "Trraa-Brand-Guidelines.pdf", "Garorock.pdf", 
            "Holiday Matsuri.pdf", "Bookipi.pdf", "StoryHero.pdf", 
            "GoCars.pdf", "Jumpp_Brand-Guidelines.pdf", "Padelsilo.pdf", 
            "David-Tribble.pdf", "Nordic-Attitude.pdf", "Friszon.pdf", 
            "Svaya.pdf", "Tasky-Brand-Guidelines.pdf", "TerraFirm.pdf", 
            "PuraSweets Brand Guidelines.pdf", "Foundry-Berlin.pdf", "Dipole.pdf", 
            "HYVE-Branding-Design.pdf", "Barbican.pdf"
        ]
    },
    "Social-Media-Posts": {
        type: "image",
    ...
    "Portfolios": {
        type: "pdf",
        files: [
            "Arya-Kagathara-Design-Portfolio.pdf", "BLKResumes.pdf", "Roberto Bolle Foundation.pdf", 
            "Mipo.pdf", "Myotonx.pdf", "NuAI.pdf", "RMS.pdf", "W3Dart.pdf"
        ]
    }
};
    ...
    data.files.forEach(file => {
        ...
        card.innerHTML = `
            ...
            <div class="card-info">
                ...
                <a href="viewer.html?file=${encodeURI(folder + '/' + file)}" class="see-more-btn">View Document</a>
            </div>
        `;
